...
document.write(perros); // Escribe dircetamente en el html el contenido de la variable
alert(gatos); // Ventana emergente con el contenido de la variable

// Convertir a numero
perros = parseInt(perros); // parseInt concierte un tipo de dato en entero
gatos = parseInt(gatos); 

// ParseInt Mas tolerable, util cuando el usuario escribe texto

let totalMascotas = perros + gatos;
// console.log se usa para imprimir mensajes en consola y depurar codigo
